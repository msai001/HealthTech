...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    try {
      ...
      setError('Ошибка при попытке входа через Google');
      console.error(error);
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
      <div className="card w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-emerald-600 mb-2">🌿</h1>
        ...
        <div className="text-center text-sm text-slate-500 dark:text-slate-400">
          <p>Используя эту службу, вы соглашаетесь с нашей политикой конфиденциальности</p>
        </div>
      </div>
    </div>
  );
